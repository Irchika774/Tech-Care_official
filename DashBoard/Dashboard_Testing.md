# 🧑‍🔧 Dashboard Testing – User Module

## Introduction
This document describes the manual testing conducted on the User
...
of user activities and earnings.
...
### U-DASH-01: Dashboard Load After Login
**Steps**
1. Log in as a user
...
### U-DASH-02: Display of Earnings, Jobs, and Ratings
**Steps**
...
---
### U-DASH-03: Zero State Display
**Steps**
1. Log in with a user account having no completed jobs
2. Observe earnings and job sections

**Expected Result**
- Zero values (e.g., 0 Active repaires, 0 my devices, 0 total Spent, 0 completed) should be displayed clearly
...
### U-DASH-04: Dashboard UI on Page Refresh
**Steps**
...
## Conclusion
The User Dashboard functions as expected. All tested scenarios
...
of user-related information after login.
