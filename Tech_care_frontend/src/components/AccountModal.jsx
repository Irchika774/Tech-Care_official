      ...
      >
        <div className="p-6">
          ...
          <div className="mt-6 pt-6 border-t border-border-light dark:border-border-dark">
            <button className="w-full flex items-center justify-center space-x-2 p-3 rounded-lg bg-red-50 dark:bg-red-900 dark:bg-opacity-20 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-opacity-30 transition">
